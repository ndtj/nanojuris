# Surface workpack — `surface:tjam:cjsg:second:tjam-cjsg`
...
```yaml
surface_id: surface:tjam:cjsg:second:tjam-cjsg
authority: TJAM
branch: state
degree: second
instance: second
...
- `docs/providers/tjam_cjsg/README.md`
- `provider-catalog:tjam_cjsg`
