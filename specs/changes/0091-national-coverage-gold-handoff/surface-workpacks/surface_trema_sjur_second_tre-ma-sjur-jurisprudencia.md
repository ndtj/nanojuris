# Surface workpack — `surface:trema:sjur:second:tre-ma-sjur-jurisprudencia`
...
```yaml
surface_id: surface:trema:sjur:second:tre-ma-sjur-jurisprudencia
authority: TREMA
branch: electoral
degree: second
instance: second
collection: SJUR
provider: tre_ma_sjur_jurisprudencia
required: true
...
- `provider-catalog:tre_ma_sjur_jurisprudencia`
