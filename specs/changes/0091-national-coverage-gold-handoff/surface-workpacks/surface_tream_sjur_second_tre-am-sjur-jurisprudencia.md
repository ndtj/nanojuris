# Surface workpack — `surface:tream:sjur:second:tre-am-sjur-jurisprudencia`
...
```yaml
surface_id: surface:tream:sjur:second:tre-am-sjur-jurisprudencia
authority: TREAM
branch: electoral
degree: second
instance: second
collection: SJUR
provider: tre_am_sjur_jurisprudencia
required: true
...
- `provider-catalog:tre_am_sjur_jurisprudencia`
