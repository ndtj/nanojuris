# Surface workpack — `surface:treac:sjur:second:tre-ac-sjur-jurisprudencia`
...
```yaml
surface_id: surface:treac:sjur:second:tre-ac-sjur-jurisprudencia
authority: TREAC
branch: electoral
degree: second
instance: second
collection: SJUR
provider: tre_ac_sjur_jurisprudencia
required: true
...
- `provider-catalog:tre_ac_sjur_jurisprudencia`
