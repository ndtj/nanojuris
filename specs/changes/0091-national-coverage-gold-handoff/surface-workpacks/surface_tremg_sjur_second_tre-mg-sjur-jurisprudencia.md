# Surface workpack — `surface:tremg:sjur:second:tre-mg-sjur-jurisprudencia`
...
```yaml
surface_id: surface:tremg:sjur:second:tre-mg-sjur-jurisprudencia
authority: TREMG
branch: electoral
degree: second
instance: second
collection: SJUR
provider: tre_mg_sjur_jurisprudencia
required: true
...
- `provider-catalog:tre_mg_sjur_jurisprudencia`
