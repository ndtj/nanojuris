# Surface workpack — `surface:tresp:sjur:second:tre-sp-sjur-jurisprudencia`
...
```yaml
surface_id: surface:tresp:sjur:second:tre-sp-sjur-jurisprudencia
authority: TRESP
branch: electoral
degree: second
instance: second
collection: SJUR
provider: tre_sp_sjur_jurisprudencia
required: true
...
- `provider-catalog:tre_sp_sjur_jurisprudencia`
