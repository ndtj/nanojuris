# Surface workpack — `surface:trero:sjur:second:tre-ro-sjur-jurisprudencia`
...
```yaml
surface_id: surface:trero:sjur:second:tre-ro-sjur-jurisprudencia
authority: TRERO
branch: electoral
degree: second
instance: second
collection: SJUR
provider: tre_ro_sjur_jurisprudencia
required: true
...
- `provider-catalog:tre_ro_sjur_jurisprudencia`
