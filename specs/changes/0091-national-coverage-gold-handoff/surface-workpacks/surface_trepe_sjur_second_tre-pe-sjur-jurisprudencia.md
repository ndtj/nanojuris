# Surface workpack — `surface:trepe:sjur:second:tre-pe-sjur-jurisprudencia`
...
```yaml
surface_id: surface:trepe:sjur:second:tre-pe-sjur-jurisprudencia
authority: TREPE
branch: electoral
degree: second
instance: second
collection: SJUR
provider: tre_pe_sjur_jurisprudencia
required: true
...
- `provider-catalog:tre_pe_sjur_jurisprudencia`
