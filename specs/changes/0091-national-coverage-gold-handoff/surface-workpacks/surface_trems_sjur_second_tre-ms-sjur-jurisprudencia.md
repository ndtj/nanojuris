# Surface workpack — `surface:trems:sjur:second:tre-ms-sjur-jurisprudencia`
...
```yaml
surface_id: surface:trems:sjur:second:tre-ms-sjur-jurisprudencia
authority: TREMS
branch: electoral
degree: second
instance: second
collection: SJUR
provider: tre_ms_sjur_jurisprudencia
required: true
...
- `provider-catalog:tre_ms_sjur_jurisprudencia`
