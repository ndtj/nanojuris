# Surface workpack — `surface:trers:sjur:second:tre-rs-sjur-jurisprudencia`
...
```yaml
surface_id: surface:trers:sjur:second:tre-rs-sjur-jurisprudencia
authority: TRERS
branch: electoral
degree: second
instance: second
collection: SJUR
provider: tre_rs_sjur_jurisprudencia
required: true
...
- `provider-catalog:tre_rs_sjur_jurisprudencia`
