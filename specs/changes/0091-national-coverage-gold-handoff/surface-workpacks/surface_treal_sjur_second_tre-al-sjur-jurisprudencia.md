# Surface workpack — `surface:treal:sjur:second:tre-al-sjur-jurisprudencia`
...
```yaml
surface_id: surface:treal:sjur:second:tre-al-sjur-jurisprudencia
authority: TREAL
branch: electoral
degree: second
instance: second
collection: SJUR
provider: tre_al_sjur_jurisprudencia
required: true
...
- `provider-catalog:tre_al_sjur_jurisprudencia`
