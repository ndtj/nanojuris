# Surface workpack — `surface:trerr:sjur:second:tre-rr-sjur-jurisprudencia`
...
```yaml
surface_id: surface:trerr:sjur:second:tre-rr-sjur-jurisprudencia
authority: TRERR
branch: electoral
degree: second
instance: second
collection: SJUR
provider: tre_rr_sjur_jurisprudencia
required: true
...
- `provider-catalog:tre_rr_sjur_jurisprudencia`
