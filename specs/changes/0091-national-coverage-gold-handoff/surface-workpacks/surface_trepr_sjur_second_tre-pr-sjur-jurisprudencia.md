# Surface workpack — `surface:trepr:sjur:second:tre-pr-sjur-jurisprudencia`
...
```yaml
surface_id: surface:trepr:sjur:second:tre-pr-sjur-jurisprudencia
authority: TREPR
branch: electoral
degree: second
instance: second
collection: SJUR
provider: tre_pr_sjur_jurisprudencia
required: true
...
- `provider-catalog:tre_pr_sjur_jurisprudencia`
