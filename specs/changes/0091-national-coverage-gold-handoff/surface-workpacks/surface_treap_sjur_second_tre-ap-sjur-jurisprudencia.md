# Surface workpack — `surface:treap:sjur:second:tre-ap-sjur-jurisprudencia`
...
```yaml
surface_id: surface:treap:sjur:second:tre-ap-sjur-jurisprudencia
authority: TREAP
branch: electoral
degree: second
instance: second
collection: SJUR
provider: tre_ap_sjur_jurisprudencia
required: true
...
- `provider-catalog:tre_ap_sjur_jurisprudencia`
