# Surface workpack — `surface:trees:sjur:second:tre-es-sjur-jurisprudencia`
...
```yaml
surface_id: surface:trees:sjur:second:tre-es-sjur-jurisprudencia
authority: TREES
branch: electoral
degree: second
instance: second
collection: SJUR
provider: tre_es_sjur_jurisprudencia
required: true
...
- `provider-catalog:tre_es_sjur_jurisprudencia`
