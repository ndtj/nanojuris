# Surface workpack — `surface:trerj:sjur:second:tre-rj-sjur-jurisprudencia`
...
```yaml
surface_id: surface:trerj:sjur:second:tre-rj-sjur-jurisprudencia
authority: TRERJ
branch: electoral
degree: second
instance: second
collection: SJUR
provider: tre_rj_sjur_jurisprudencia
required: true
...
- `provider-catalog:tre_rj_sjur_jurisprudencia`
