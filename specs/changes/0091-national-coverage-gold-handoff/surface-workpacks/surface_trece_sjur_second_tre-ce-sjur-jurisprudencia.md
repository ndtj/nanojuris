# Surface workpack — `surface:trece:sjur:second:tre-ce-sjur-jurisprudencia`
...
```yaml
surface_id: surface:trece:sjur:second:tre-ce-sjur-jurisprudencia
authority: TRECE
branch: electoral
degree: second
instance: second
collection: SJUR
provider: tre_ce_sjur_jurisprudencia
required: true
...
- `provider-catalog:tre_ce_sjur_jurisprudencia`
