# Surface workpack — `surface:trepi:sjur:second:tre-pi-sjur-jurisprudencia`
...
```yaml
surface_id: surface:trepi:sjur:second:tre-pi-sjur-jurisprudencia
authority: TREPI
branch: electoral
degree: second
instance: second
collection: SJUR
provider: tre_pi_sjur_jurisprudencia
required: true
...
- `provider-catalog:tre_pi_sjur_jurisprudencia`
