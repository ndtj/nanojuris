# Surface workpack — `surface:trepb:sjur:second:tre-pb-sjur-jurisprudencia`
...
```yaml
surface_id: surface:trepb:sjur:second:tre-pb-sjur-jurisprudencia
authority: TREPB
branch: electoral
degree: second
instance: second
collection: SJUR
provider: tre_pb_sjur_jurisprudencia
required: true
...
- `provider-catalog:tre_pb_sjur_jurisprudencia`
