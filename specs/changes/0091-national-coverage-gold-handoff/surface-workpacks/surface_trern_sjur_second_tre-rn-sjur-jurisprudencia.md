# Surface workpack — `surface:trern:sjur:second:tre-rn-sjur-jurisprudencia`
...
```yaml
surface_id: surface:trern:sjur:second:tre-rn-sjur-jurisprudencia
authority: TRERN
branch: electoral
degree: second
instance: second
collection: SJUR
provider: tre_rn_sjur_jurisprudencia
required: true
...
- `provider-catalog:tre_rn_sjur_jurisprudencia`
