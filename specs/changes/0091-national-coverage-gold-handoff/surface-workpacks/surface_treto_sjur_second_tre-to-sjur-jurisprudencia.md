# Surface workpack — `surface:treto:sjur:second:tre-to-sjur-jurisprudencia`
...
```yaml
surface_id: surface:treto:sjur:second:tre-to-sjur-jurisprudencia
authority: TRETO
branch: electoral
degree: second
instance: second
collection: SJUR
provider: tre_to_sjur_jurisprudencia
required: true
...
- `provider-catalog:tre_to_sjur_jurisprudencia`
