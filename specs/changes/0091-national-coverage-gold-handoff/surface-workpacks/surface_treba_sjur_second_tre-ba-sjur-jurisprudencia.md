# Surface workpack — `surface:treba:sjur:second:tre-ba-sjur-jurisprudencia`
...
```yaml
surface_id: surface:treba:sjur:second:tre-ba-sjur-jurisprudencia
authority: TREBA
branch: electoral
degree: second
instance: second
collection: SJUR
provider: tre_ba_sjur_jurisprudencia
required: true
...
- `provider-catalog:tre_ba_sjur_jurisprudencia`
