# Surface workpack — `surface:military-first-degree-units:portal:first:gap`
...
```yaml
surface_id: surface:military-first-degree-units:portal:first:gap
authority: MILITARY_FIRST_DEGREE_UNITS
branch: military
degree: first
instance: first
collection: PORTAL
