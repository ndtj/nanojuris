# Surface workpack — `surface:tjrj:eproc:mixed:tjrj-eproc-jurisprudencia`
...
```yaml
surface_id: surface:tjrj:eproc:mixed:tjrj-eproc-jurisprudencia
authority: TJRJ
branch: state
degree: mixed
instance: mixed
...
- `docs/provider-discovery/state-eproc-degree-live-20260913.json`
