# Surface workpack — `surface:trepa:sjur:second:tre-pa-sjur-jurisprudencia`
...
```yaml
surface_id: surface:trepa:sjur:second:tre-pa-sjur-jurisprudencia
authority: TREPA
branch: electoral
degree: second
instance: second
collection: SJUR
provider: tre_pa_sjur_jurisprudencia
required: true
...
- `provider-catalog:tre_pa_sjur_jurisprudencia`
