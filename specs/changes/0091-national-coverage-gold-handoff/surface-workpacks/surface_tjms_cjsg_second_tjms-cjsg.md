# Surface workpack — `surface:tjms:cjsg:second:tjms-cjsg`
...
```yaml
surface_id: surface:tjms:cjsg:second:tjms-cjsg
authority: TJMS
branch: state
degree: second
instance: second
...
- `docs/providers/tjms_cjsg/README.md`
- `provider-catalog:tjms_cjsg`
