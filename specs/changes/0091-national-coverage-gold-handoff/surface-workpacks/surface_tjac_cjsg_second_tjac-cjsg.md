# Surface workpack — `surface:tjac:cjsg:second:tjac-cjsg`
...
```yaml
surface_id: surface:tjac:cjsg:second:tjac-cjsg
authority: TJAC
branch: state
degree: second
instance: second
...
- `docs/providers/tjac_cjsg/README.md`
- `provider-catalog:tjac_cjsg`
