# Surface workpack — `surface:tresc:sjur:second:tre-sc-sjur-jurisprudencia`
...
```yaml
surface_id: surface:tresc:sjur:second:tre-sc-sjur-jurisprudencia
authority: TRESC
branch: electoral
degree: second
instance: second
collection: SJUR
provider: tre_sc_sjur_jurisprudencia
required: true
...
- `provider-catalog:tre_sc_sjur_jurisprudencia`
