# Surface workpack — `surface:tredf:sjur:second:tre-df-sjur-jurisprudencia`
...
```yaml
surface_id: surface:tredf:sjur:second:tre-df-sjur-jurisprudencia
authority: TREDF
branch: electoral
degree: second
instance: second
collection: SJUR
provider: tre_df_sjur_jurisprudencia
required: true
...
- `provider-catalog:tre_df_sjur_jurisprudencia`
