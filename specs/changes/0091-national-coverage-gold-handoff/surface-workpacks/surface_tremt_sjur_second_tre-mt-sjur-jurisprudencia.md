# Surface workpack — `surface:tremt:sjur:second:tre-mt-sjur-jurisprudencia`
...
```yaml
surface_id: surface:tremt:sjur:second:tre-mt-sjur-jurisprudencia
authority: TREMT
branch: electoral
degree: second
instance: second
collection: SJUR
provider: tre_mt_sjur_jurisprudencia
required: true
...
- `provider-catalog:tre_mt_sjur_jurisprudencia`
