# Surface workpack — `surface:trese:sjur:second:tre-se-sjur-jurisprudencia`
...
```yaml
surface_id: surface:trese:sjur:second:tre-se-sjur-jurisprudencia
authority: TRESE
branch: electoral
degree: second
instance: second
collection: SJUR
provider: tre_se_sjur_jurisprudencia
required: true
...
- `provider-catalog:tre_se_sjur_jurisprudencia`
