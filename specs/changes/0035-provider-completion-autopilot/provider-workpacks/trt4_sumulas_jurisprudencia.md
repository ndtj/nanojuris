# Work pack — TRT4 Súmulas e precedentes (coleção curada)

Source ID: trt4_sumulas_jurisprudencia
Lifecycle: runtime
...
- busca textual: True
- filtros: text, exact_phrase, number, document_type, page
- paginação: local_html_window
- completude: unknown
...
- módulo: src/nanojuris/providers/trt4_sumulas_jurisprudencia.py
- dossier: docs/providers/trt4_sumulas_jurisprudencia/README.md
- source contract: docs/source-contracts/trt4_sumulas_jurisprudencia.md
