# Work pack — TJCE SJURIS

Source ID: tjce_sjuris
Lifecycle: runtime
...
- busca textual: True
- filtros: text, all_words, any_words, without_words, exact_phrase, types, source_origins
- paginação: page
- completude: unknown
...
- dossier: docs/providers/tjce_sjuris/README.md
- source contract: docs/source-contracts/tjce_sjuris.md
...
- tests/test_tjce_sjuris.py

### Fixtures

- tjce_sjuris_empty.json
- tjce_sjuris_results.json
- tjce_sjuris_schema_drift.json
