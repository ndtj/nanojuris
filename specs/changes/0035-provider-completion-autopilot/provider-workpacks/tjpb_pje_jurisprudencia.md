# Work pack — TJPB PJe Jurisprudencia

Source ID: tjpb_pje_jurisprudencia
Lifecycle: runtime
...
- busca textual: True
- filtros: text, number, case_class, judging_body, rapporteur, published_from, published_to, judgment_date_from, judgment_date_to, source_origin, degree, instance
- paginação: page
- completude: unknown
...
- módulo: src/nanojuris/providers/tjpb_pje_jurisprudencia.py
- dossier: docs/providers/tjpb_pje_jurisprudencia/README.md
- source contract: docs/source-contracts/tjpb_pje_jurisprudencia.md
...
- tjpb_access_control.html
- tjpb_pje_jurisprudencia_success.json
...
- gap:Ampliar fixtures de token, vazio e desafio de acesso.
- gap:Validar live o detalhe HTML com identificador da busca em baixa frequencia.
