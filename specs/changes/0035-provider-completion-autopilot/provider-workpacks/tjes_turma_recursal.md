# Work pack — TJES Jurisprudencia/Turma Recursal

Source ID: tjes_turma_recursal
Lifecycle: runtime
...
- módulo: src/nanojuris/providers/tjes_turma_recursal.py
- dossier: docs/providers/tjes_turma_recursal/README.md
- source contract: docs/source-contracts/tjes_turma_recursal.md
...
- tests/test_tjes_turma_recursal.py
- tests/test_tjes_turma_recursal_live.py

### Fixtures

- tjes_turma_recursal_empty.json
- tjes_turma_recursal_invalid.json
- tjes_turma_recursal_schema_drift.json
- tjes_turma_recursal_success.json
