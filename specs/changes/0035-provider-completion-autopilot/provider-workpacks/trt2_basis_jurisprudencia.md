# Work pack — TRT2 BASIS — Boletins de Jurisprudência

Source ID: trt2_basis_jurisprudencia
Lifecycle: runtime
...
- busca textual: True
- filtros: text, exact_phrase, number, degree, instance, branch, authority, collection, document_type, page
- paginação: dspace_page
- completude: unknown
...
- módulo: src/nanojuris/providers/trt2_basis_jurisprudencia.py
- dossier: docs/providers/trt2_basis_jurisprudencia/README.md
- source contract: docs/source-contracts/trt2_basis_jurisprudencia.md
...
- tests/test_trt2_basis_jurisprudencia.py

### Fixtures

- trt2_basis_search.html
