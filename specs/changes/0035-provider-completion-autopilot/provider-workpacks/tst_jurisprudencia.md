# Work pack — TST Jurisprudencia

Source ID: tst_jurisprudencia
Lifecycle: runtime
...
- busca textual: True
- filtros: text, all_words, any_words, without_words, exact_phrase, number, published_from, published_to, updated_from, updated_to, types
- paginação: offset
- completude: unknown
...
- módulo: src/nanojuris/providers/tst_jurisprudencia.py
- dossier: docs/providers/tst_jurisprudencia/README.md
- source contract: docs/source-contracts/tst_jurisprudencia.md
...
- tests/test_tst_jurisprudencia_live.py

### Fixtures

- tst_jurisprudencia_responsabilidade.json
...
- gap:Consultar config.json quando a base da API for alterada pelo frontend.
- gap:Ampliar fixtures por sumulas, precedentes normativos e filtros de catalogo.
- gap:Monitorar alteracoes no HTML de inteiro teor e nos campos removidos do backend.
