# Work pack — TJAC Consulta de Jurisprudencia/CJSG
...
- módulo: src/nanojuris/providers/tjac_cjsg.py
- dossier: docs/providers/tjac_cjsg/README.md
- source contract: docs/source-contracts/tjac_cjsg.md
