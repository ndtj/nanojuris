# Work pack — TJRO Jurisprudencia textual

Source ID: tjro_jurisprudencia
Lifecycle: runtime
...
- busca textual: True
- filtros: text, exact_phrase, number, rapporteur, updated_from, updated_to, fetch_details
- paginação: offset
- completude: unknown
...
- módulo: src/nanojuris/providers/tjro_jurisprudencia.py
- dossier: docs/providers/tjro_jurisprudencia/README.md
- source contract: docs/source-contracts/tjro_jurisprudencia.md
...
- tjro_jurisprudencia_access_control.json
- tjro_jurisprudencia_empty.json
- tjro_jurisprudencia_error.json
- tjro_jurisprudencia_invalid.json
- tjro_jurisprudencia_related.json
- tjro_jurisprudencia_results.json
- tjro_jurisprudencia_schema_drift.json
