# Work pack — TJMT Jurisprudencia API

Source ID: tjmt_jurisprudencia_api
Lifecycle: runtime
...
- busca textual: True
- filtros: text, exact_phrase, all_words, any_words, without_words, number, published_from, published_to, types, order_by
- paginação: page
- completude: unknown
...
- dossier: docs/providers/tjmt_jurisprudencia_api/README.md
- source contract: docs/source-contracts/tjmt_jurisprudencia_api.md
...
- tests/test_tjmt_jurisprudencia_api.py

### Fixtures

- tjmt_jurisprudencia_results.json
