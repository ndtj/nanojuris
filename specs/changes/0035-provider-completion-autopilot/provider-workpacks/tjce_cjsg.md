# Work pack — TJCE Consulta de Jurisprudencia/CJSG
...
- busca textual: True
- filtros: text, number, exact_phrase, case_class, judging_body, updated_from, updated_to, published_from, published_to, types, order_by
- paginação: page
- completude: unknown
...
- módulo: src/nanojuris/providers/tjce_cjsg.py
- dossier: docs/providers/tjce_cjsg/README.md
- source contract: docs/source-contracts/tjce_cjsg.md
