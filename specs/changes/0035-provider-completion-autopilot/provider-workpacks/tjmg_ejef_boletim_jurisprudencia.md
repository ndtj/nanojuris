# Work pack — TJMG/EJEF Boletim de Jurisprudencia

Source ID: tjmg_ejef_boletim_jurisprudencia
Lifecycle: runtime
...
- módulo: src/nanojuris/providers/tjmg_ejef_boletim_jurisprudencia.py
- dossier: docs/providers/tjmg_ejef_boletim_jurisprudencia/README.md
- source contract: docs/source-contracts/tjmg_ejef_boletim_jurisprudencia.md
...
- tests/test_tjmg_ejef_boletim_jurisprudencia.py

### Fixtures

- tjmg_ejef_boletim_empty.json
- tjmg_ejef_boletim_invalid.json
- tjmg_ejef_boletim_search.json
