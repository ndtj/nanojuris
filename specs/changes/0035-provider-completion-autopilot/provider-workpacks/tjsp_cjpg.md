# Work pack — TJSP CJPG Jurisprudencia (1o grau)
...
- busca textual: True
- filtros: text, exact_phrase, number, updated_from, updated_to
- paginação: page
- completude: unknown
...
- módulo: src/nanojuris/providers/tjsp_cjpg.py
- dossier: docs/providers/tjsp_cjpg/README.md
- source contract: docs/source-contracts/tjsp_cjpg.md
...
- tests/test_tjms_cjpg.py
- tests/test_tjsp_cjpg.py
- tests/test_tjsp_cjpg_live.py

### Fixtures

- tjsp_cjpg_access_control.html
- tjsp_cjpg_empty.html
- tjsp_cjpg_schema_drift.html
- tjsp_cjpg_success.html
