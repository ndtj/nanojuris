# Work pack — STM Jurisprudencia JMU

Source ID: stm_jurisprudencia
Lifecycle: runtime
...
- módulo: src/nanojuris/providers/stm_jurisprudencia.py
- dossier: docs/providers/stm_jurisprudencia/README.md
- source contract: docs/source-contracts/stm_jurisprudencia.md
...
- tests/test_stm_jurisprudencia.py
...
- gap:Documentar paginacao remota e facetas se forem estaveis.
- gap:Adicionar fixtures de pagina vazia, pagina com multiplos resultados e inteiro teor.
- gap:Mapear variacoes de labels acentuados no HTML.
