# Work pack — TJAM Consulta de Jurisprudencia/CJSG
...
- módulo: src/nanojuris/providers/tjam_cjsg.py
- dossier: docs/providers/tjam_cjsg/README.md
- source contract: docs/source-contracts/tjam_cjsg.md
