# Work pack — TJES Jurisprudencia/CJSG (2o grau)

Source ID: tjes_jurisprudencia
Lifecycle: runtime
...
- módulo: src/nanojuris/providers/tjes_jurisprudencia.py
- dossier: docs/providers/tjes_jurisprudencia/README.md
- source contract: docs/source-contracts/tjes_jurisprudencia.md
...
- tests/test_tjes_jurisprudencia.py
- tests/test_tjes_jurisprudencia_live.py

### Fixtures

- tjes_cjsg_empty.json
- tjes_cjsg_html_only.json
- tjes_cjsg_invalid.json
- tjes_cjsg_schema_drift.json
- tjes_cjsg_success.json
