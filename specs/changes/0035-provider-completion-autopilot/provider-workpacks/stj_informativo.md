# Work pack — STJ Informativo

Source ID: stj_informativo
Lifecycle: runtime
...
- módulo: src/nanojuris/providers/stj_informativo.py
- dossier: docs/providers/stj_informativo/README.md
- source contract: docs/source-contracts/stj_informativo.md
...
- tests/test_stj_informativo.py

### Fixtures

- stj_informativo_infanticidio.html
- stj_informativo_multiplas_notas.html
...
- gap:Mapear filtros oficiais por ramo, orgao julgador e ministro.
