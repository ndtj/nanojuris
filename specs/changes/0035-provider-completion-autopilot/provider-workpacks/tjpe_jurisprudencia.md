# Work pack — TJPE Consulta de Jurisprudencia

Source ID: tjpe_jurisprudencia
Lifecycle: runtime
...
- busca textual: True
- filtros: text, number, rapporteur, case_class, published_from, published_to, judgment_date_from, judgment_date_to, types, order_by
- paginação: offset
- completude: unknown
...
- módulo: src/nanojuris/providers/tjpe_jurisprudencia.py
- dossier: docs/providers/tjpe_jurisprudencia/README.md
- source contract: docs/source-contracts/tjpe_jurisprudencia.md
...
- tests/test_tjpe_jurisprudencia.py

### Fixtures

- tjpe_jurisprudencia_results.json
- tjpe_juscraper_choice_ascii.html
- tjpe_juscraper_empty.html
- tjpe_juscraper_results_ascii.html
- tjpe_juscraper_search.html
