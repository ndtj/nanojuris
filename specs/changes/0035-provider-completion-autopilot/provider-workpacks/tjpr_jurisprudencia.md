# Work pack — TJPR Jurisprudencia

Source ID: tjpr_jurisprudencia
Lifecycle: runtime
...
- busca textual: True
- filtros: text, number, published_from, published_to, updated_from, updated_to, judgment_date_from, judgment_date_to, courts, rapporteur, case_class, judging_body, types, fetch_details
- paginação: page
- completude: unknown
...
- módulo: src/nanojuris/providers/tjpr_jurisprudencia.py
- dossier: docs/providers/tjpr_jurisprudencia/README.md
- source contract: docs/source-contracts/tjpr_jurisprudencia.md
...
- tests/test_tjpr_jurisprudencia.py

### Fixtures

- tjpr_jurisprudencia_results.html
...
- gap:Ampliar fixtures por filtros e estados de conteudo pendente.
- gap:Validar se a rota de detalhe pode ser carregada por URL preservada.
