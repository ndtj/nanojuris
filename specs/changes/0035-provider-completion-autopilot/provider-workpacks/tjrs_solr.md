# Work pack — TJRS Jurisprudencia AJAX/SOLR
...
- busca textual: True
- filtros: text, exact_phrase, number, page, published_from, published_to
- paginação: offset
- completude: unknown
...
- módulo: src/nanojuris/providers/tjrs_solr.py
- dossier: docs/providers/tjrs_solr/README.md
- source contract: docs/source-contracts/tjrs_solr.md
...
- tests/test_tjrs_solr.py

### Fixtures

- provider_contracts.json
- tjrs_solr_results.json
...
- gap:Validar pagina vazia e pagina posterior em monitoramento live controlado.
- gap:Mapear rotas publicas de detalhe e inteiro teor antes de anuncia-las.
