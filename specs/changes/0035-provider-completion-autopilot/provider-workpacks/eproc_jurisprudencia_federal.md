# Work pack — eproc federal jurisprudência (família opt-in)

Source ID: eproc_jurisprudencia_federal
Lifecycle: runtime
...
- módulo: src/nanojuris/providers/eproc_jurisprudencia_federal.py
- dossier: docs/providers/eproc_jurisprudencia_federal/README.md
- source contract: docs/source-contracts/eproc_jurisprudencia_federal.md
