# Work pack — TRT9 NUGEP/NUGEPNAC (compilacao curada)

Source ID: trt9_nugepnac_jurisprudencia
Lifecycle: runtime
...
- busca textual: True
- filtros: text, exact_phrase, number, collection, page
...
- módulo: src/nanojuris/providers/trt9_nugepnac_jurisprudencia.py
- dossier: docs/providers/trt9_nugepnac_jurisprudencia/README.md
- source contract: docs/source-contracts/trt9_nugepnac_jurisprudencia.md
...
- tests/test_trt9_nugepnac_jurisprudencia.py

### Fixtures

- trt9_nugepnac_success.json

## Evidência live versionada

- status: valid_curated_context
- data: 2026-09-10
...
- live_status:valid_curated_context
