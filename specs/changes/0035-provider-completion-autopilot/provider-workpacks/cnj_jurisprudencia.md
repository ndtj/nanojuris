# Work pack — CNJ Informativos de Jurisprudencia

Source ID: cnj_jurisprudencia
Lifecycle: runtime
...
- busca textual: True
- filtros: text, number, published_from, published_to, page
- paginação: page
- completude: unknown
...
- módulo: src/nanojuris/providers/cnj_jurisprudencia.py
- dossier: docs/providers/cnj_jurisprudencia/README.md
- source contract: docs/source-contracts/cnj_jurisprudencia.md
...
- tests/test_cnj_jurisprudencia.py

### Fixtures

- cnj_jurisprudencia_empty.html
- cnj_jurisprudencia_results.html
- cnj_jurisprudencia_schema_drift.html
