# Work pack — TJSE Boletim Jurídico (CJSG)

Source ID: tjse_boletim_jurisprudencia
Lifecycle: runtime
...
- busca textual: True
- filtros: text, exact_phrase, number, degree, instance, branch, page, judgment_date_from, judgment_date_to
- paginação: edition_section
- completude: unknown
...
- módulo: src/nanojuris/providers/tjse_boletim_jurisprudencia.py
- dossier: docs/providers/tjse_boletim_jurisprudencia/README.md
- source contract: docs/source-contracts/tjse_boletim_jurisprudencia.md
...
- tests/test_tjse_boletim_jurisprudencia.py

### Fixtures

- tjse_boletim_detail.html
- tjse_boletim_empty.html
- tjse_boletim_empty.html.
- tjse_boletim_principal.html
- tjse_boletim_search.html
