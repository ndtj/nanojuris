# Work pack — TJMG Biblioteca Digital — Jurisprudência (CJSG)

Source ID: tjmg_dspace_jurisprudencia
Lifecycle: runtime
...
- busca textual: True
- filtros: text, exact_phrase, number, degree, instance, branch, page
- paginação: merged_collection_page
- completude: unknown
...
- módulo: src/nanojuris/providers/tjmg_dspace_jurisprudencia.py
- dossier: docs/providers/tjmg_dspace_jurisprudencia/README.md
- source contract: docs/source-contracts/tjmg_dspace_jurisprudencia.md
...
- tests/test_tjmg_dspace_jurisprudencia.py

### Fixtures

- tjmg_dspace_empty.json
- tjmg_dspace_schema_drift.json
- tjmg_dspace_search.json
