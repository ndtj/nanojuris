# Work pack — TJMA Informativos de Jurisprudência

Source ID: tjma_informativos
Lifecycle: runtime
...
- busca textual: False
- filtros: page, authority, branch, degree, instance, collection
...
- módulo: src/nanojuris/providers/tjma_informativos.py
- dossier: docs/providers/tjma_informativos/README.md
- source contract: docs/source-contracts/tjma_informativos.md
...
- tests/test_tjma_informativos.py

### Fixtures

- tjma_informativos_success.html
