# Work pack — TJMS CJPG Jurisprudencia (1o grau)
...
- módulo: src/nanojuris/providers/tjms_cjpg.py
- dossier: docs/providers/tjms_cjpg/README.md
- source contract: docs/source-contracts/tjms_cjpg.md
...
- tjms_cjpg_access_control.html
- tjms_cjpg_empty.html
- tjms_cjpg_schema_drift.html
- tjms_cjpg_success.html
