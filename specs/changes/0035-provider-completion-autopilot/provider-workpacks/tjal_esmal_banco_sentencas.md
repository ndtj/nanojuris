# Work pack — TJAL ESMAL Banco de Sentencas (CJPG curado)

Source ID: tjal_esmal_banco_sentencas
Lifecycle: runtime
...
- busca textual: True
- filtros: text, exact_phrase, number, legal_area, degree, instance, branch, authority, collection, page
- paginação: remote_page
- completude: unknown
...
- módulo: src/nanojuris/providers/tjal_esmal_banco_sentencas.py
- dossier: docs/providers/tjal_esmal_banco_sentencas/README.md
- source contract: docs/source-contracts/tjal_esmal_banco_sentencas.md
...
- tjal_esmal_empty.html
- tjal_esmal_invalid.html
- tjal_esmal_invalid.pdf
- tjal_esmal_success.html
