# Work pack — TJMG Jurisprudência API (CJSG)

Source ID: tjmg_jurisprudencia
Lifecycle: runtime
...
- busca textual: True
- filtros: text, number, types, case_class, rapporteur, judging_body, courts, legal_area, document_type, decision_type, exact_phrase, all_words, degree, instance, branch, collection, judgment_date_from, judgment_date_to, published_from, published_to, order_by
- paginação: page
- completude: unknown
...
- módulo: src/nanojuris/providers/tjmg_jurisprudencia.py
- dossier: docs/providers/tjmg_jurisprudencia/README.md
- source contract: docs/source-contracts/tjmg_jurisprudencia.md
...
- tests/test_tjmg_jurisprudencia.py

### Fixtures

- tjmg_jurisprudencia_captcha.html
- tjmg_jurisprudencia_modern.json
- tjmg_jurisprudencia_modern_empty.json
- tjmg_jurisprudencia_modern_error.json
- tjmg_jurisprudencia_modern_schema.json
