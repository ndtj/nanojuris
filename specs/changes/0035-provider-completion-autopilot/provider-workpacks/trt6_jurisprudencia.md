# Work pack — TRT6 Jurisprudencia

Source ID: trt6_jurisprudencia
Lifecycle: runtime
...
- busca textual: True
- filtros: text, number, published_from, published_to, rapporteur, judging_body, authority, branch, degree, instance, collection, document_type
- paginação: offset
- completude: unknown
...
- módulo: src/nanojuris/providers/trt6_jurisprudencia.py
- dossier: docs/providers/trt6_jurisprudencia/README.md
- source contract: docs/source-contracts/trt6_jurisprudencia.md
...
- tests/test_trt6_jurisprudencia.py

### Fixtures

- trt6_legacy_search_success.html
- trt6_pje_authorized_success.json
- trt6_pje_options.json
- trt6_pje_recaptcha_error.json
