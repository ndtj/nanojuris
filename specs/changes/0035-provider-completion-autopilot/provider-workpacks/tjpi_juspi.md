# Work pack — TJPI JusPI Jurisprudencias

Source ID: tjpi_juspi
Lifecycle: runtime
...
- busca textual: True
- filtros: text, exact_phrase, number, types, rapporteur, source_origin, updated_from, updated_to, degree, instance, decision_type
- paginação: page
- completude: unknown
...
- módulo: src/nanojuris/providers/tjpi_juspi.py
- dossier: docs/providers/tjpi_juspi/README.md
- source contract: docs/source-contracts/tjpi_juspi.md
...
- tests/test_tjpi_contract.py
- tests/test_tjpi_juspi.py
- tests/test_tjpi_live.py

### Fixtures

- tjpi_juspi_dano_moral.html
- tjpi_juspi_detail.html
- tjpi_juspi_empty.html
...
- gap:Adicionar validacao live opt-in de detalhe e pagina posterior.
- gap:Catalogar valores textuais dos filtros publicados no formulario.
