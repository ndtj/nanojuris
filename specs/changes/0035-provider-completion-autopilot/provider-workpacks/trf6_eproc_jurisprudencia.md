# Work pack — TRF6 eproc Jurisprudencia

Source ID: trf6_eproc_jurisprudencia
Lifecycle: runtime
...
- módulo: src/nanojuris/providers/trf6_eproc_jurisprudencia.py
- dossier: docs/providers/trf6_eproc_jurisprudencia/README.md
- source contract: docs/source-contracts/trf6_eproc_jurisprudencia.md
...
- gap:Aprofundar filtros de origem TRF6, TRU6, Turmas Recursais e Varas Federais.
