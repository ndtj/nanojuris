# Work pack — TJMS Consulta de Jurisprudencia/CJSG
...
- módulo: src/nanojuris/providers/tjms_cjsg.py
- dossier: docs/providers/tjms_cjsg/README.md
- source contract: docs/source-contracts/tjms_cjsg.md
