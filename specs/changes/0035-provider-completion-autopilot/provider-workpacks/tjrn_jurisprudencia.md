# Work pack — TJRN Jurisprudencia textual (portal unificado)

Source ID: tjrn_jurisprudencia
Lifecycle: runtime
...
- busca textual: True
- filtros: text, exact_phrase, number, page, degree, instance, case_class, judging_body, source_origin, decision_type, judgment_date_from, judgment_date_to
- paginação: page
- completude: unknown
...
- módulo: src/nanojuris/providers/tjrn_jurisprudencia.py
- dossier: docs/providers/tjrn_jurisprudencia/README.md
- source contract: docs/source-contracts/tjrn_jurisprudencia.md
...
- tests/test_tjrn_jurisprudencia_live.py

### Fixtures

- tjrn_jurisprudencia_empty.json
- tjrn_jurisprudencia_invalid.json
- tjrn_jurisprudencia_schema_drift.json
- tjrn_jurisprudencia_success.json
