# Work pack — TJAP Banco de Sentenças (CJPG)

Source ID: tjap_banco_sentencas
Lifecycle: runtime
...
- busca textual: True
- filtros: text, exact_phrase, number, case_class, judging_body, types, judgment_date_from, judgment_date_to, page
- paginação: livewire_page
- completude: unknown
...
- módulo: src/nanojuris/providers/tjap_banco_sentencas.py
- dossier: docs/providers/tjap_banco_sentencas/README.md
- source contract: docs/source-contracts/tjap_banco_sentencas.md
...
- tests/test_tjap_banco_sentencas.py

### Fixtures

- tjap_banco_sentencas_blocked.html
- tjap_banco_sentencas_empty.html
- tjap_banco_sentencas_sigiloso.html
- tjap_banco_sentencas_success.html
