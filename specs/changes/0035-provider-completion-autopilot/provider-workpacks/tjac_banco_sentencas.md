# Work pack — TJAC Banco de Sentencas (CJPG curado)

Source ID: tjac_banco_sentencas
Lifecycle: runtime
...
- módulo: src/nanojuris/providers/tjac_banco_sentencas.py
- dossier: docs/providers/tjac_banco_sentencas/README.md
- source contract: docs/source-contracts/tjac_banco_sentencas.md
...
- tests/test_tjac_banco_sentencas.py

### Fixtures

- tjac_banco_sentencas_index.html
