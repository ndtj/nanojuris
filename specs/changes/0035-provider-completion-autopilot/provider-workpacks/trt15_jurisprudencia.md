# Work pack — TRT15 Jurisprudência

Source ID: trt15_jurisprudencia
Lifecycle: runtime
...
- busca textual: True
- filtros: text, all_words, any_words, exact_phrase, without_words, case_class, judging_body, rapporteur, published_from, published_to, page, document_type
- paginação: page
- completude: unknown
...
- módulo: src/nanojuris/providers/trt15_jurisprudencia.py
- dossier: docs/providers/trt15_jurisprudencia/README.md
- source contract: docs/source-contracts/trt15_jurisprudencia.md
...
- tests/test_trt15_jurisprudencia.py

### Fixtures

- trt15_jurisprudencia_captcha.json
- trt15_jurisprudencia_empty.json
- trt15_jurisprudencia_options.json
- trt15_jurisprudencia_page2.json
- trt15_jurisprudencia_schema_drift.json
- trt15_jurisprudencia_success.json
...
- live_status:not_checked_in_latest_focused_run
...
- live:not_checked_in_latest_focused_run
...
- rodar validacao live pequena com termo juridico padrao
