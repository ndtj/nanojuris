# Work pack — TRF2 eproc Jurisprudencia

Source ID: trf2_eproc_jurisprudencia
Lifecycle: runtime
...
- módulo: src/nanojuris/providers/trf2_eproc_jurisprudencia.py
- dossier: docs/providers/trf2_eproc_jurisprudencia/README.md
- source contract: docs/source-contracts/trf2_eproc_jurisprudencia.md
...
- gap:Aprofundar filtros de origem TRF2, TRU2 e Turmas Recursais.
