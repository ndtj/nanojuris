# Work pack — TRT8 PJe Jurisprudencia

Source ID: trt8_pje_jurisprudencia
Lifecycle: runtime
...
- busca textual: True
- filtros: text, all_words, any_words, without_words, case_class, judging_body, rapporteur, published_from, published_to, document_type, degree, instance, branch, authority, collection, page, fetch_details
- paginação: page
- completude: unknown
...
- módulo: src/nanojuris/providers/trt8_pje_jurisprudencia.py
- dossier: docs/providers/trt8_pje_jurisprudencia/README.md
- source contract: docs/source-contracts/trt8_pje_jurisprudencia.md
...
- tests/test_trt8_pje_jurisprudencia.py

### Fixtures

- trt8_pje_blocked.json
- trt8_pje_detail.json
- trt8_pje_empty.json
- trt8_pje_page2.json
- trt8_pje_schema_invalid.json
- trt8_pje_success.json
