# Federated promotion live smoke — cycle 45
...
- **18/18 fontes promovidas chamadas**;
- **18/18 janelas parseáveis**;
...
O manifesto de promoção habilitou tecnicamente 18 fontes no rollout local.
Fontes `opt_in` e bloqueadas não foram chamadas nesta rodada.

Evidência estruturada: `federated-promotion-live-20260905-cycle45.json`.
