...
Gerado em `2026-09-05T17:50:24+00:00`; modo `live_bounded`; providers: **52**.

## Resumo

- Observados: **52**; sem observação: **0**.
- Rotas declaradas: **148**; candidatas observadas: **2314**.
- Filtros declarados: **277**; campos observados: **208**.
