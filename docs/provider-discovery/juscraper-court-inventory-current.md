...
- Pacotes TRF: **4**
- Bindings runtime no cruzamento (inclui diagnósticos): **138**
- Providers runtime federáveis no cruzamento: **78**
- Bindings diagnósticos opt-in (inclui 27 TRE): **60**
...
| `tjmg` | `cjsg`, `cpopg`, `cposg` | `tjmg_jurisprudencia` | `covered_by_existing_runtime` | `maintenance` |
...
| `tjrj` | `cjsg`, `cpopg`, `cposg` | `tjrj_ejuris` | `partial_overlap_review` | `P2_compare_contracts` |
...
- **22** pacotes possuem equivalentes runtime com evidência live válida para todas as superfícies jurisprudenciais mapeadas.
- **1** pacotes possuem ao menos uma superfície bloqueada; continuam fora da contagem de cobertura.
