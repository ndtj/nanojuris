...
- Pacotes TRF: **4**
- Providers runtime NanoJuris no cruzamento: **52**
...
| `tjap` | `cjsg`, `cpopg`, `cposg` | — | `candidate_no_runtime_equivalent` | `P0_gap` |
| `tjba` | `cjsg`, `cpopg`, `cposg` | `tjba_graphql` | `covered_by_existing_runtime` | `maintenance` |
| `tjce` | `cjsg`, `cpopg`, `cposg` | `tjce_cjsg` | `runtime_overlap_blocked` | `P0_access_or_transport` |
...
| `tjmg` | `cjsg`, `cpopg`, `cposg` | — | `candidate_no_runtime_equivalent` | `P0_gap` |
...
| `tjpe` | `cjsg`, `cpopg`, `cposg` | `tjpe_jurisprudencia` | `runtime_overlap_blocked` | `P0_access_or_transport` |
...
| `tjsp` | `cjsg`, `cjpg`, `cpopg`, `cposg` | `tjsp_cjpg`, `tjsp_cjsg` | `runtime_overlap_blocked` | `P0_access_or_transport` |
...
- **18** pacotes possuem equivalentes runtime com evidência live válida para todas as superfícies jurisprudenciais mapeadas.
- **3** pacotes possuem ao menos uma superfície bloqueada; continuam fora da contagem de cobertura.
- **0** pacotes possuem runtime, mas carecem de evidência live válida atual.
- **2** lacunas não têm equivalente runtime; devem ser pesquisadas individualmente, sem assumir que o upstream funciona hoje.
