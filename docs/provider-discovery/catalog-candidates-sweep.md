...
Gerado em `2026-08-20T05:41:25+00:00`; modo `live_bounded`; providers: **0**.

## Resumo

- Observados: **0**; sem observação: **0**.
- Rotas declaradas: **0**; candidatas observadas: **0**.
- Filtros declarados: **0**; campos observados: **0**.
- Providers com sinais de controle de acesso: **0**.
...
| `justica_eleitoral_sjur` | discovery_error | 0 | reproduzir a URL documentada com diagnóstico explícito antes de implementar |
| `tjap_tucujuris` | observed | 3 | criar adapter somente após contrato, fixture de sucesso/vazio/erro e parser canônico |
| `tjes_jurisprudencia` | observed | 1 | criar adapter somente após contrato, fixture de sucesso/vazio/erro e parser canônico |
| `tjmg_jurisprudencia` | observed | 3 | criar adapter somente após contrato, fixture de sucesso/vazio/erro e parser canônico |
| `tjrn_jurisprudencia` | observed | 3 | criar adapter somente após contrato, fixture de sucesso/vazio/erro e parser canônico |
| `tjse_jurisprudencia` | observed | 1 | criar adapter somente após contrato, fixture de sucesso/vazio/erro e parser canônico |
| `trf3_jurisprudencia` | observed | 3 | criar adapter somente após contrato, fixture de sucesso/vazio/erro e parser canônico |
