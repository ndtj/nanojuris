...
Gerado em `2026-09-05T19:14:36+00:00`; modo `live_bounded`; providers: **52**.

## Resumo

- Observados: **52**; sem observação: **0**.
- Rotas declaradas: **148**; candidatas observadas: **2433**.
- Filtros declarados: **277**; campos observados: **219**.
...
| `tjsc_eproc_jurisprudencia` | 1 | access_controlled:1 | 119 | 11 | documentar controle de acesso/SSO e confirmar rota pública alternativa |
