...
Gerado em `2026-09-02T19:05:16+00:00`; modo `live_bounded`; providers: **50**.

## Resumo

- Observados: **50**; sem observação: **0**.
- Rotas declaradas: **146**; candidatas observadas: **2373**.
- Filtros declarados: **269**; campos observados: **211**.
...
| `tjrs_solr` | 1 | valid:1 | 430 | 68 | confirmar payload, filtros e paginação dos endpoints POST com fixture |
...
| `tnu_eproc_jurisprudencia` | 1 | access_controlled:1 | 107 | 4 | documentar controle de acesso/SSO e confirmar rota pública alternativa |
...
| `tjrn_jurisprudencia` | observed | 1 | criar adapter somente após contrato, fixture de sucesso/vazio/erro e parser canônico |
