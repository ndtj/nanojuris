...
Gerado em `2026-09-01T22:01:11+00:00`; modo `live_bounded`; providers: **49**.

## Resumo

- Observados: **49**; sem observação: **0**.
- Rotas declaradas: **139**; candidatas observadas: **1918**.
- Filtros declarados: **262**; campos observados: **191**.
- Providers com sinais de controle de acesso: **9**.
...
| `tjrj_eproc_jurisprudencia` | 1 | robots_disallowed:1 | 0 | 0 | revisar robots.txt e agendar nova coleta autorizada |
