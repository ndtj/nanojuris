...
- Estados: `{"covered_requires_differential_fixture": 26, "detail_contract_unverified": 1, "out_of_scope": 58, "runtime_overlap_blocked": 2}`
...
| `tjmg` | `cjsg` | `tjmg_jurisprudencia` | `runtime_overlap_blocked` | `client.py`, `download.py`, `parse.py` |
...
| `tjrj` | `cpopg` | `tjrj_eproc_jurisprudencia` | `out_of_scope` | `client.py` |
| `tjrj` | `cposg` | `tjrj_eproc_jurisprudencia` | `out_of_scope` | `client.py` |
