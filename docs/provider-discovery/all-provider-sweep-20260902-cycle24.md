...
Gerado em `2026-09-02T19:03:34+00:00`; modo `live_bounded`; providers: **50**.

## Resumo

- Observados: **50**; sem observação: **0**.
- Rotas declaradas: **146**; candidatas observadas: **2394**.
- Filtros declarados: **269**; campos observados: **223**.
...
| `tjmt_jurisprudencia_api` | 1 | candidate:1 | 29 | 12 | capturar e validar GETs declarados ainda não observados |
