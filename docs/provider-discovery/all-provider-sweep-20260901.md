...
Gerado em `2026-09-01T07:34:25+00:00`; modo `live_bounded`; providers: **46**.

## Resumo

- Observados: **46**; sem observação: **0**.
- Rotas declaradas: **135**; candidatas observadas: **2253**.
- Filtros declarados: **246**; campos observados: **207**.
- Providers com sinais de controle de acesso: **8**.
...
| `tjce_informativos` | 1 | valid:1 | 345 | 16 | capturar e validar GETs declarados ainda não observados |
