...
Snapshot local: `2026-08-11`. Este relatorio e uma fotografia reproduzivel do estado documental;
...
- Dossies auditados: **55** (34 implemented, 20 candidates, 1 family).
- Dossies com secoes estruturais: **30/55**.
- Canonical/legacy em paridade: **55/55**.
- Prontidao: `family_spec`=1, `implementation_ready`=1, `needs_deepening`=33, `research_incomplete`=14, `research_ready`=6.
...
| [`cnj_jurisprudencia`](docs/providers/cnj_jurisprudencia/README.md) | candidate | `research_incomplete` | - | research | next_steps | 6 | 0 |
...
| [`falcao_jt`](docs/providers/falcao_jt/README.md) | candidate | `research_incomplete` | - | research | data, mcp | 0 | 0 |
...
| [`stm_jurisprudencia`](docs/providers/stm_jurisprudencia/README.md) | implemented | `needs_deepening` | 4 | medio | - | 8 | 0 |
...
| [`tjap_tucujuris`](docs/providers/tjap_tucujuris/README.md) | candidate | `research_incomplete` | - | research | contract, data, mcp | 0 | 0 |
| [`tjba_graphql`](docs/providers/tjba_graphql/README.md) | candidate | `research_incomplete` | - | research | identity, data, mcp, next_steps | 0 | 0 |
| [`tjce_cjsg`](docs/providers/tjce_cjsg/README.md) | candidate | `research_incomplete` | - | research | data | 7 | 0 |
| [`tjce_informativos`](docs/providers/tjce_informativos/README.md) | candidate | `research_ready` | - | research | - | 5 | 0 |
| [`tjdf_juris`](docs/providers/tjdf_juris/README.md) | implemented | `needs_deepening` | 5 | baixo | data, states, next_steps | 0 | 0 |
| [`tjes_jurisprudencia`](docs/providers/tjes_jurisprudencia/README.md) | candidate | `research_incomplete` | - | research | contract, mcp | 0 | 0 |
...
| [`tjmg_jurisprudencia`](docs/providers/tjmg_jurisprudencia/README.md) | candidate | `research_incomplete` | - | research | data, mcp | 0 | 0 |
...
| [`tjpe_jurisprudencia`](docs/providers/tjpe_jurisprudencia/README.md) | candidate | `research_incomplete` | - | research | next_steps | 0 | 0 |
| [`tjpi_juspi`](docs/providers/tjpi_juspi/README.md) | implemented | `needs_deepening` | 4 | medio | - | 4 | 3 |
| [`tjpr_jurisprudencia`](docs/providers/tjpr_jurisprudencia/README.md) | candidate | `research_incomplete` | - | research | data, mcp, next_steps | 0 | 0 |
| [`tjrj_eproc_jurisprudencia`](docs/providers/tjrj_eproc_jurisprudencia/README.md) | implemented | `needs_deepening` | 4 | medio | - | 6 | 0 |
| [`tjrn_jurisprudencia`](docs/providers/tjrn_jurisprudencia/README.md) | candidate | `research_incomplete` | - | research | data, mcp | 0 | 0 |
| [`tjro_liame`](docs/providers/tjro_liame/README.md) | candidate | `research_incomplete` | - | research | contract, data, mcp, next_steps | 0 | 0 |
...
| [`tjse_jurisprudencia`](docs/providers/tjse_jurisprudencia/README.md) | candidate | `research_incomplete` | - | research | contract, data, mcp | 0 | 0 |
...
| [`tjto_jurisprudencia`](docs/providers/tjto_jurisprudencia/README.md) | candidate | `research_incomplete` | - | research | contract, mcp | 0 | 0 |
...
| [`trf3_jurisprudencia`](docs/providers/trf3_jurisprudencia/README.md) | candidate | `research_incomplete` | - | research | data | 7 | 0 |
| [`trf4_eproc_jurisprudencia`](docs/providers/trf4_eproc_jurisprudencia/README.md) | implemented | `needs_deepening` | 5 | baixo | data, states, next_steps | 0 | 0 |
