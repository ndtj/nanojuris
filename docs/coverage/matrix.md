...
| [`justica_eleitoral_sjur`](../providers/justica_eleitoral_sjur/README.md) | implemented | `curated_context` | 43 | `context` | `P1_contextual_value` | `not_checked_in_latest_focused_run` | nao | nao | `needs_deepening` |
| [`stf_informativo`](../providers/stf_informativo/README.md) | implemented | `primary_textual_jurisprudence` | 82 | `gold` | `P0_harden_for_unified_search` | `not_checked_in_latest_focused_run` | sim | nao | `needs_deepening` |
| [`stf_juris`](../providers/stf_juris/README.md) | implemented | `primary_textual_jurisprudence` | 77 | `blocked` | `P0_harden_for_unified_search` | `tls_verification_failed` | sim | nao | `needs_deepening` |
...
| [`tjrj_ejuris`](../providers/tjrj_ejuris/README.md) | candidate | `mapped_candidate` | 11 | `mapped` | `P1_candidate_contract` | `not_checked_in_latest_focused_run` | nao | nao | `research_ready` |
