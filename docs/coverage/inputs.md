...
| `tjac_cjsg` | sim | text, number | `unknown` | nao | nao |
| `tjal_cjsg` | sim | text, number | `unknown` | nao | nao |
| `tjam_cjsg` | sim | text, number | `unknown` | nao | nao |
...
| `tjms_cjsg` | sim | text, number | `unknown` | nao | nao |
...
| `tjrj_eproc_jurisprudencia` | sim | text, number | `unknown` | nao | nao |
...
| `tjsc_eproc_jurisprudencia` | sim | text, number | `unknown` | nao | nao |
| `tjse_jurisprudencia` | nao | - | `unknown` | nao | nao |
| `tjsp_cjsg` | sim | text, number | `unknown` | nao | nao |
| `tjsp_eproc_jurisprudencia` | sim | text, number | `unknown` | nao | nao |
| `tjsp_nugepnac` | sim | text, number, types | `unknown` | sim | nao |
| `tjto_jurisprudencia` | nao | - | `unknown` | nao | nao |
| `tnu_eproc_jurisprudencia` | sim | text, number | `unknown` | nao | nao |
| `tre_sp_temas` | sim | text, exact_phrase | `unknown` | sim | nao |
| `trf2_eproc_jurisprudencia` | sim | text, number | `unknown` | nao | nao |
...
| `trf6_eproc_jurisprudencia` | sim | text, number | `unknown` | nao | nao |
