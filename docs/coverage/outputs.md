...
| `tjsp_eproc_jurisprudencia` | CanonicalDecision | sentenca, acordao, decisao_monocratica | html | 12 | nao | sim |
| `tjsp_nugepnac` | CanonicalPrecedent | irdr, iac | html | 12 | nao | sim |
| `tjto_jurisprudencia` | - | - | - | 0 | nao | nao |
