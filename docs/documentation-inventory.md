...
Documentos inventariados: **189** (`active_guide`=36, `canonical`=74, `compatibility_copy`=54, `generated`=10, `historical_evidence`=15).
...
| `README.md` | `canonical` | 25 | Entrada normativa, de produto ou de governanca. | `manter` |
...
| `docs/candidate-live-validation-2026-08-11.md` | `historical_evidence` | 58 | Registro de pesquisa, QA ou validacao. | `manter` |
...
| `docs/coverage/maturity-waves.md` | `generated` | 1 | Gerado por build_provider_coverage.py. | `manter` |
...
| `docs/live-validation-2026-08-11.md` | `historical_evidence` | 68 | Registro de pesquisa, QA ou validacao. | `manter` |
