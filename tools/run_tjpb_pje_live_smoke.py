"""Run a bounded live smoke for the public TJPB PJe jurisprudence API."""
...
DEFAULT_OUTPUT = ROOT / "docs" / "provider-discovery" / "tjpb-pje-live-20260905-cycle55.json"
...
def run(output: Path) -> dict[str, Any]:
    provider = TjpbPjeJurisprudenciaProvider(NanoJurisConfig(timeout=20, rate_limit_interval=0))
    ...
    report = {
        "schema_version": "tjpb-pje-live-v1",
        "generated_at": datetime.now(timezone.utc).isoformat(),
        "mode": "live_bounded",
        "source": "tjpb_pje_jurisprudencia",
        "source_id": "tjpb_pje_jurisprudencia",
        "surface": "search",
